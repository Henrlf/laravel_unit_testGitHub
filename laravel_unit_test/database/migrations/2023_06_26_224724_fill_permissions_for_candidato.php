...
class FillPermissionsForCandidato extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCandidato constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.candidato',
            'admin.candidato.index',
            'admin.candidato.create',
            'admin.candidato.show',
            'admin.candidato.edit',
            'admin.candidato.delete',
            'admin.candidato.bulk-delete',
        ]);
